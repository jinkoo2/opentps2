...
if __name__ == '__main__':
    ...
    for idxExp in range(1,11):
        ...
        if amplitude == 'model':
            ...
            valZ = modelValues
            valX = getAverageModelValuesAroundPosition(gtvCenterOfMass, dynMod, dimensionUsed='X')
            valY = getAverageModelValuesAroundPosition(gtvCenterOfMass, dynMod, dimensionUsed='Y')
