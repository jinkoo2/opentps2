...
class Projection(Image2D):
    def __init__(self, imageArray=None, name="2D Image", origin=(0, 0, 0), spacing=(1, 1), seriesInstanceUID="", projectionAngle=0, rotationAxis='Z', sourceImage=None):
        super().__init__(imageArray=imageArray, name=name, origin=origin, spacing=spacing, seriesInstanceUID=seriesInstanceUID)
