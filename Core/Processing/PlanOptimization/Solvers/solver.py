...
def solve(functions, x0, **kwargs):
    ...
    logger.info('Selected solver : {}'.format(solver.__class__.__name__))

    if params['output'] is not None:
        j_out = {}
        j_out["evolution"] = []
        j_out["opti_params"] = params
